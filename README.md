# spako-javalin-react
A Basic Javalin web application configured for a ReactJS single page client application, using Kotlin in the middle
tier.

*This is a port of an equivalent Java project - this project may well not (yet) be 100% idiomatic Kotlin!*
